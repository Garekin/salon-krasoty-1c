...
Процедура ПриОпределенииРегистрационныхДанныхОрганизации(Организация, Поля, Дата, РегистрационныеДанные, КодЯзыка) Экспорт
	...
	Реквизиты = ОбщегоНазначения.ЗначенияРеквизитовОбъекта(Организация,
		"Наименование, ИНН, Руководитель, ДолжностьРуководителя, ГлавныйБухгалтер");

	РегистрационныеДанные.Вставить("Наименование",          Реквизиты.Наименование);
	РегистрационныеДанные.Вставить("ИНН",                   Реквизиты.ИНН);
	РегистрационныеДанные.Вставить("Руководитель",          Реквизиты.Руководитель);
	РегистрационныеДанные.Вставить("ДолжностьРуководителя", Реквизиты.ДолжностьРуководителя);
	РегистрационныеДанные.Вставить("ГлавныйБухгалтер",      Реквизиты.ГлавныйБухгалтер);
